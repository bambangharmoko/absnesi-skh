...
import { Camera, LayoutDashboard, Users, FileSpreadsheet, Download, Clock, Sparkles } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 w-full bg-slate-900/90 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          {/* Right Clock & PWA Install Button */}
          <div className="flex items-center gap-3">
            ...
            {isInstallable && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white text-xs font-bold flex items-center gap-1.5 shadow-lg shadow-emerald-600/30 transition animate-pulse"
              >
